...
translations = {
    ...
    'cn': {
        ...
        'about': '关于2048',
        'aboutText': '2048是由Gabriele Cirulli于2014年3月创建的一款令人上瘾的益智游戏。这个游戏迅速成为全球现象，衍生出众多变体和改编版本。游戏目标简单而具有挑战性：合并相同的数字以创建数字2048的方块。',
        'gameMechanics': '游戏机制',
        ...
        'zodiacCycleList_0': '从鼠和牛开始',
        'zodiacCycleList_1': '合并它们创造出虎',
        'zodiacCycleList_2': '继续通过兔、龙、蛇',
        'zodiacCycleList_3': '然后是马、羊、猴',
        'zodiacCycleList_4': '最后到达鸡、狗和猪',
        ...
        'aiArtDescription': '这个特别版本通过人工智能的视角致敬泰勒斯威夫特。我们使用AI技术创造了泰勒独特的艺术诠释，每一幅都捕捉了她不同风格和个性的特点。',
        'gameplayFeatures': '游戏特色',
        'gameplayText': '在游戏过程中，你将发现各种AI生成的泰勒肖像：',
